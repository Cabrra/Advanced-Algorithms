...
// OrthoNormalInverse (THIS SHOULD BE THE FIRST FUNCTION YOU COMPLETE. YOUR OTHER FUNCTIONS WILL NOT APPEAR TO WORK PROPERLY WITHOUT IT.)
//
...
// TurnTo
//
// Implementation of the Turn To Algorithm (x2) for rotation about the Y-Axis (Left/Right) and rotation about the X-Axis (Up/Down)
//
// See: Matrix Behaviors.doc
//
// In:
