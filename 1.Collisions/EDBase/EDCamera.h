...
public:
	...
	enum EDCameraMode{MOUSE_LOOK = 0, HARD_ATTACH, SOFT_ATTACH, LOOK_AT, TURN_TO, MODE_COUNT};
	...
	const matrix4f &GetMatrix(void){ return m_CameraMat; }

	const matrix4f *m_pTargetMat;
	
	vec3f		m_OffsetVec;

	EDCameraMode GetCameraMode(void){ return (EDCameraMode)m_iCameraMode; }
};
